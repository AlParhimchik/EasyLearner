package com.example.sashok.easylearner.lib;
...
import com.example.sashok.easylearner.lib.*;
import com.example.sashok.easylearner.lib.FlingCardListener;
...
public class SwipeFlingAdapterView extends com.example.sashok.easylearner.lib.BaseFlingAdapterView {
    ...
    private com.example.sashok.easylearner.lib.FlingCardListener flingCardListener;
    ...
    private void setTopView() {
        if(getChildCount()>0){
            ...
            if(mActiveCard!=null) {
                ...
                flingCardListener = new com.example.sashok.easylearner.lib.FlingCardListener(mActiveCard, mAdapter.getItem(0),
